...
El profe tambien quiso que aplicara varios tipos de busquedas, asi que implemente la busqueda binaria. Para usarla convierto la lista en un vector, lo ordeno por numero y luego aplico binaria
...
- Elminar contacto: borra un contacto de la lista ligada
